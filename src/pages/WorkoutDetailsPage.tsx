        ...
        <header className="flex items-center gap-3 border-b border-[var(--border)] pb-4">
            ...
            <div className="min-w-0 flex-1">
                ...
                {workout && <div className="space-y-1 text-xs text-[var(--muted-foreground)]">
                    ...
                    <p className="flex flex-wrap items-center gap-1 font-mono"><Clock className="size-3" />{formatTime(workout.startTime)} – {workout.endTime === null ? t('timed.active') : formatTime(workout.endTime)}
