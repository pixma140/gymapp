...
// When imported by the test suite we expose the app and bootstrap helpers
// without binding a port or auto-creating the admin account.
...
export { app, db, initDatabase, bootstrapAdmin };
